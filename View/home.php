...
<html class="no-js" lang="en">
	...
	<body>
				        ...
				        <div class="container">            
				            ...
				            <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
				                <ul class="nav navbar-nav navbar-center" data-in="fadeInDown" data-out="fadeOutUp">
				                    ...
				                    <li ><a href="View/NewArrival.php">new arrival</a></li>
				                    <li ><a href="View/Features.php">features</a></li>
		...
		<!--welcome-hero end -->
  <h1 align="center" style="margin-top:5%;">populer-products </h1>
		...
		<!--promotion-->
		<button class="btn-cart welcome-add-cart populer-products-btn"  id="see-all" onclick="window.location.href='NewArrival.php'">
			See All
		</button>
		<section id="populer-products" class="populer-products">
			<div class="container">
							...
							<div class="single-populer-products">
								<div class="single-inner-populer-products">
									<div class="row">
										<div class="col-md-4 col-sm-12">
											<div class="single-inner-populer-product-img">
												<img src="assets/images/collection/arrivals7.png" alt="populer-products images">
											</div>
										</div>
										<div class="col-md-8 col-sm-12">
											<div class="single-inner-populer-product-txt">
							...
							<div class="single-populer-products">
								<div class="single-inner-populer-products">
									<div class="row">
										<div class="col-md-4 col-sm-12">
											<div class="single-inner-populer-product-img">
												<img src="assets/images/collection/arrivals3.png" alt="populer-products images">
											</div>
										</div>
										<div class="col-md-8 col-sm-12">
											<div class="single-inner-populer-product-txt">
