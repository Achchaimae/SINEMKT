...
<html class="no-js" lang="en">
  ...
  <body>
    ...
    <center>
      <div id="new-arrivals">
        <a href="#scroll" style="background: red">
          <button
            style="
        ...
        <div id="sofa-collection">
          <div class="owl-carousel owl-theme" id="collection-carousel">
            <div class="sofa-collection collectionbg1">
              <div class="container">
                <div class="sofa-collection-txt">
                  ...
                  <!-- <a href="#blog" style="background: red">
                    <button
                      style="
                        background: blue;
                        position: absolute !important;
            ...
            <!--/.sofa-collection-->
            <div class="sofa-collection collectionbg2" id="blog">
              <div class="container">
                <div class="sofa-collection-txt">
                  <h1>Latest Blog</h1>
                  <p>Why Brands are Looking at Local Language</p>
      ...
      <div class="container">
        <div class="hm-footer-copyright text-center">
          ...
          <p>
            ...
            <a href="https://www.themesine.com/">Achchaimae Khalaf</a>
          </p>
          <!--/p-->
        </div>
        <!--/.text-center-->
